...
RATE = 9
vel_pub = rclpy.Publisher(VEL_TOPIC, Twist, queue_size=1)
bumper_pub = rclpy.Publisher(JOY_BUMPER_TOPIC, Bool, queue_size=1)
button = None
bumper = False
...
def main():
	rclpy.init_node("Joy2Locobot", anonymous=False)
