...
def main():
	...
	rclpy.init_node("PD_CONTROLLER", anonymous=False)
	waypoint_sub = rclpy.Subscriber(WAYPOINT_TOPIC, Float32MultiArray, callback_drive, queue_size=1)
	reached_goal_sub = rclpy.Subscriber(REACHED_GOAL_TOPIC, Bool, callback_reached_goal, queue_size=1)
	vel_out = rclpy.Publisher(VEL_TOPIC, Twist, queue_size=1)
